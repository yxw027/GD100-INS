...
#define GYRO_WALK (0.56*0.01)  //*3.5
#define VEL_WALK (800)   //*2.5

/*--------------------------------IMU STD-----------------------------*/
#define GYRO_STD_X (0.011*sqrt(IMU_BW_HZ))
#define ACC_STD_X (0.000105*sqrt(IMU_BW_HZ))
...
#define WORK_PATH  "G:/无人船数据/I90测试数据/"
#define TEST_RAW_FILE_PATH	 WORK_PATH
#define TEST_RAW_FILE_NAME	   "070700_gilc_raw.txt"

//#define WORK_PATH  "G:/i90固件/I90测试/test2/"
//#define TEST_RAW_FILE_PATH	 WORK_PATH
//#define TEST_RAW_FILE_NAME	   "055635_raw.txt"
